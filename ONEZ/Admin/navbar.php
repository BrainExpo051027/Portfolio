...
<?php
  $r=mysqli_query($conn,"SELECT COUNT(status) as total FROM message where status='no' and sender='student';");
  $count=mysqli_fetch_assoc($r);
  $sql_app = mysqli_query($conn, "SELECT COUNT(status) as total FROM admin WHERE status='';");
